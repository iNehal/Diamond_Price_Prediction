...
class DataTransformationConfig:
    preprocessor_obj_file_path=os.path.join('artifacts','preprocessor.pkl') #pkl means pickle file
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info('Exception occured in the initiate_datatransfomation')
            raise CustomException(e,sys)